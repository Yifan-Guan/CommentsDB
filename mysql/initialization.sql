...
VALUES 
(1, 0, "重温经典！同道中人点个赞"),
(2, 0, "好看吗 老夫十年书虫但是就是没看过番茄的吞噬星空 哈哈哈希望不会失望");
...
VALUES (1, "科幻网文评价维度", "./science_fiction_scale.xlsx");
...
VALUES (1, "第一章 罗峰", "www.qidian.com/chapter/1639199/28520417/");
...
VALUES 
(1, 1, "2017-08-19", "贰貨Qiqi", "未知"),
(2, 1, "2024-07-10", "财神爷s", "浙江");

INSERT INTO `analysises` (
`analysis_comment_id`,
`analysis_scale_id`,
`analysis_result`
)
